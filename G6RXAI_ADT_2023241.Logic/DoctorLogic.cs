   ...
   public class DoctorLogic
    {
        ...
        public void AddDoctor(Doctor doctor)
            ...
            //private void CheckCarBrand(CarBrand carBrand)
            //{
            //    if (carBrand == null)
            //    {
            //        throw new ArgumentNullException(nameof(carBrand), "CarBrand cannot be null.");
            //    }

            //    if (string.IsNullOrWhiteSpace(carBrand.Name))
            //    {
            //        throw new ArgumentException("CarBrand name cannot be empty.", nameof(carBrand));
            //    }
